...
class RegisterForm(Form):
    ...
    email = StringField("E-Mail Adresi",validators=[validators.Email(message="Lütfen Geçerli Bir E-Mail Giriniz.")])
...
app = Flask(__name__)
app.secret_key= "brkblog"
app.config["MYSQL_HOST"] = "localhost"
app.config["MYSQL_USER"] = "root"
app.config["MYSQL_PASSWORD"] = ""
app.config["MYSQL_DB"] = "brkblog"
